...
public class ExcelDataAdapterComposite extends AFileDataAdapterComposite {
	...
	public ExcelDataAdapterComposite(Composite parent, int style, JasperReportsContext jrContext) {
		...
		format.setItems(new String[] { ExcelFormatEnum.AUTODETECT.getName(), ExcelFormatEnum.XLS.getName(), ExcelFormatEnum.XLSX.getName() });
	...
	public DataAdapterDescriptor getDataAdapter() {
		...
		ExcelDataAdapter xlsDataAdapter = (ExcelDataAdapter) dataAdapterDesc.getDataAdapter();
