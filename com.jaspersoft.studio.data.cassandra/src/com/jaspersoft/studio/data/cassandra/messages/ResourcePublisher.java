...
public class ResourcePublisher extends com.jaspersoft.studio.messages.ResourcePublisher{
	...
	public String getPluginName() {
		return "com.jaspersoft.studio.data.cassandra";
	}
	...
	protected List<AbstractResourceDefinition> initializeProperties(){
		...
		result.add(new PackageResourceDefinition("en_EN", 
												 "com.jaspersoft.studio.data.cassandra.messages", 
												 "messages.properties", 
												 "In this file there are the strings used by the Cassandra data adapter",
												 getClassLoader(),
												 "com/jaspersoft/studio/data/cassandra/messages/messages.properties", this));
