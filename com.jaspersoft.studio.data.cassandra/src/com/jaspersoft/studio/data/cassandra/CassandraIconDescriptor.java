 ...
 */
public class CassandraIconDescriptor extends NodeIconDescriptor {
	 ...
	 *            the name
	 */
	public CassandraIconDescriptor(String name) {
	...
	public void setResourceBundleIcons(ResourceBundle resourceBundleIcons) {
		CassandraIconDescriptor.resourceBundleIcons = resourceBundleIcons;
	}
}
