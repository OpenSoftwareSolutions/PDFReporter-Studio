...
public class ResourcePublisher extends com.jaspersoft.studio.messages.ResourcePublisher{
	...
	public String getPluginName() {
		return "com.jaspersoft.studio.data.hive";
	}
	...
	protected List<AbstractResourceDefinition> initializeProperties(){
		...
		result.add(new PackageResourceDefinition("en_EN", 
												 "com.jaspersoft.studio.data.hive.messages", 
												 "messages.properties", 
												 "In this file there are the strings used by the Hive data adapter",
												 getClassLoader(),
												 "com/jaspersoft/studio/data/hive/messages/messages.properties", this));
