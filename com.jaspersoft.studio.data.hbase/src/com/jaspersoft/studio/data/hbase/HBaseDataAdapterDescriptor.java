 ...
 * 
 */
public class HBaseDataAdapterDescriptor extends DataAdapterDescriptor implements IFieldsProvider, IWizardDataEditorProvider {
	public static final long serialVersionUID = JRConstants.SERIAL_VERSION_UID;
	private IFieldsProvider fieldsProvider;

	public HBaseDataAdapterDescriptor() {
		dataAdapter = new HBaseDataAdapterImpl();
	}
	...
	public DataAdapterEditor getEditor() {
		return new HBaseDataAdapterEditor();
	}
	...
	private void getFieldProvider() {
		if (fieldsProvider == null)
			fieldsProvider = new HBaseDataAdapterFieldsProvider();
	}
	...
	public DataAdapter getDataAdapter() {
		if (dataAdapter == null)
			dataAdapter = new HBaseDataAdapterImpl();
		return (HBaseDataAdapter) dataAdapter;
	}
